...

{
    ...
    "[",str _modelInfo,"] call { lineIntersectsSurfaces [AGLToASL positionCameraToWorld [0,0,0], AGLToASL positionCameraToWorld [0,0,5], player, objNull, true, 1, ""GEOM"", ""NONE""] select 0 params ["""","""",""_object"",""""];
	...
	{
		lineIntersectsSurfaces [AGLToASL positionCameraToWorld [0,0,0], AGLToASL positionCameraToWorld [0,0,5], player, objNull, true, 1, "GEOM", "NONE"] select 0 params ["_pos1","","_object",""];
		Scavenge_Client_Objects = [_object,_pos1];
	};
	...
	private _codeExecutedOnCompetion =
	{
		...
		[_configClassName, Scavenge_Client_Objects select 0, Scavenge_Client_Objects select 1] call ExileExpansionClient_system_scavenge_action_conditionEvents;
		Scavenge_Client_Objects = [];
	};
