...
{
	["ExileOnPlayerConnected", "onPlayerConnected", { [_uid, _name, _owner] call ExileServer_system_network_event_onPlayerConnected; }] call BIS_fnc_addStackedEventHandler;
...
{
	onPlayerConnected {[_uid, _name, _owner] call ExileServer_system_network_event_onPlayerConnected};
